    ...
    <div class="project-single--header">
        <div class="container">
            <div class="heading heading-very-large dark-1">
                <h1>CRUSH STATION - Crush Station Restaurent Serves as One Of the Best Places for Young Hearts..</h1>
                ...
                <div class="row">
                    <div class="col-md-3">
                        <div class="project-single-client">
                            ...
                            <h3 class="heading heading-small dark-1">Crush Station</h3>
                        </div>
                    </div>
                    <div class="col-md-3">
        ...
        <div class="swiper-wrapper">
            <div class="swiper-slide">
                <div class="single-image">
                    <img src="{{asset('assets\images\project-detailed\crush-station\Sho_048848-1-scaled.jpg')}}" alt="project_detailed_img1">
            ...
            <div class="swiper-slide">
                <div class="single-image">
                    <img src="{{asset('assets\images\project-detailed\crush-station\Sho_048833.jpg')}}" alt="project_detailed_img2">
            ...
            <div class="swiper-slide">
                <div class="single-image">
                    <img src="{{asset('assets\images\project-detailed\crush-station\Sho_042389.jpg')}}" alt="project_detailed_img3">
...
<div class="project-content">
    <div class="project-content-wrapper">
        ...
        <div class="single-image-wrapper">
            <div class="single-image">
                <img src="{{'assets\images\project-detailed\crush-station\Sho_042434-2.jpg'}}" alt="project-detailed-2" style="transform: scaleX(-1);">
            ...
            <div class="single-image">
                <img src="{{'assets\images\project-detailed\crush-station\Sho_042439.jpg'}}" alt="project-detailed-3">
        ...
        <div class="single-image" style="background-color:#13263f;">
            <div style="background-image:url({{asset('assets/images/project-detailed/crush-station/food-wooden-background.jpg')}}); height:600px; width:100%; opacity:0.2;background-size:100% 600px; background-repeat:no-repeat">
