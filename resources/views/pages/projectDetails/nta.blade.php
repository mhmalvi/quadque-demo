...
@section('title', 'Noble Training Academy - Quadque Digital')
    ...
    <div class="project-single--header">
        <div class="container">
            <div class="heading heading-very-large dark-1">
                <h1>Noble Training Academy - Recognition of Prior Learning (RPL) Certificate in Australia.</h1>
            </div>
        </div>
                ...
                <div class="row">
                    <div class="col-md-3">
                        <div class="project-single-client">
                            ...
                            <h3 class="heading heading-small dark-1">NTA</h3>
                        </div>
                    </div>
                    <div class="col-md-3">
        ...
        <div class="swiper-wrapper">
            <div class="swiper-slide">
                <div class="single-image">
                    <img src="{{asset('assets\images\project-detailed\nta\BT.jpg')}}" alt="">
...
<div class="project-content">
    <div class="project-content-wrapper">
        ...
        <div class="single-image-wrapper">
            <div class="single-image">
                <img src="{{'assets\images\project-detailed\nta\thumb02.jpg'}}" alt="project-detailed-2">

            </div>
            <div class="single-image">
                <img src="{{'assets\images\project-detailed\nta\thumb03.jpg'}}" alt="project-detailed-3">
        ...
        <div class="single-image" style="background-color:#13263f;">
            <div style="background-image:url({{asset('assets/images/project-detailed/nta/ezgif.com-gif-maker.jpg')}}); height:600px; width:100%; opacity:0.2;background-size:100% 600px; background-repeat:no-repeat">
