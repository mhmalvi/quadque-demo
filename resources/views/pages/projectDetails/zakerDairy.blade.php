...
@section('title', 'Zaker Dairy - Quadque Digital')
    ...
    <div class="project-single--header">
        <div class="container">
            <div class="heading heading-very-large dark-1">
                <h1>Zaker Dairy - We Ensure Our Quality For Your Best Healthy Eating Experience.</h1>
                ...
                <div class="row">
                    <div class="col-md-3">
                        <div class="project-single-client">
                            ...
                            <h3 class="heading heading-small dark-1">Zaker Dairy</h3>
                        </div>
                    </div>
                    <div class="col-md-3">
        ...
        <div class="swiper-wrapper">
            <div class="swiper-slide">
                <div class="single-image">
                    <img src="{{asset('assets\images\project-detailed\zaker-dairy\1657781300.png')}}" alt="">
                </div>
            </div>

            <div class="swiper-slide">
                <div class="single-image">
                    <img src="{{asset('assets\images\project-detailed\zaker-dairy\mithai-with-diya.jpg')}}" alt="">
                </div>
            </div>

            <div class="swiper-slide">
                <div class="single-image">
                    <img src="{{asset('assets\images\project-detailed\zaker-dairy\rasgulla-sweet-food.jpg')}}" alt="">
                </div>
            </div>
            <div class="swiper-slide">
                <div class="single-image">
                    <img src="{{asset('assets\images\project-detailed\zaker-dairy\sugar-cardamom.jpg')}}" alt="">
                </div>
            </div>
            <div class="swiper-slide">
                <div class="single-image">
                    <img src="{{asset('assets\images\project-detailed\zaker-dairy\top-view.jpg')}}" alt="">
                </div>
            </div>
...
<div class="project-content">
    <div class="project-content-wrapper">
        ...
        <div class="single-image-wrapper">
            <div class="single-image">
                <img src="{{'assets\images\project-detailed\zaker-dairy\1655885656.jpg'}}" alt="project-detailed-2">
            </div>
            <div class="single-image">
                <img src="{{'assets\images\project-detailed\zaker-dairy\1656304577.jpg'}}" alt="project-detailed-3">
        ...
        <div class="single-image" style="background-color:#13263f;">
            <div style="background-image:url({{asset('assets/images/project-detailed/zaker-dairy/fancy-cakes-banquet-table.jpg')}}); height:600px; width:100%; opacity:0.2;background-size:100% 600px; background-repeat:no-repeat">
