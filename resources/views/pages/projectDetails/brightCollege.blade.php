...
@section('title', 'Bright College Australia - Quadque Digital')
    ...
    <div class="project-single--header">
        <div class="container">
            <div class="heading heading-very-large dark-1">
                <h1>BRIGHT COLLEGE AUSTRALIA - WE Guide You On Every Step In Your Career To Provide A World-Class Education Experience .</h1>
                ...
                <div class="row">
                    <div class="col-md-3">
                        <div class="project-single-client">
                            ...
                            <h3 class="heading heading-small dark-1">Bright College</h3>
                        </div>
                    </div>
                    <div class="col-md-3">
        ...
        <div class="swiper-wrapper">
            <div class="swiper-slide">
                <div class="single-image">
                    <img src="{{asset('assets\images\project-detailed\bright-college\business-team-applauding-speaker-meeting.jpg')}}" alt="project_detailed_img1">
            ...
            <div class="swiper-slide">
                <div class="single-image">
                    <img src="{{asset('assets\images\project-detailed\bright-college\group-friends-eating-restaurant.jpg')}}" alt="project_detailed_img2">
            ...
            <div class="swiper-slide">
                <div class="single-image">
                    <img src="{{asset('assets\images\project-detailed\bright-college\group-hotel-staffs-standing-kitchen.jpg')}}" alt="project_detailed_img3">

                </div>
            </div>
            <div class="swiper-slide">
                <div class="single-image">
                    <img src="{{asset('assets\images\project-detailed\bright-college\workers-giving-ideas-new-project.jpg')}}" alt="project_detailed_img3">

                </div>
            </div>
            <div class="swiper-slide">
                <div class="single-image">
                    <img src="{{asset('assets\images\project-detailed\bright-college\waiters-serve-table.jpg')}}" alt="project_detailed_img3">
...
<div class="project-content">
    <div class="project-content-wrapper">
        ...
        <div class="single-image-wrapper">
            <div class="single-image">
                <img src="{{'assets\images\project-detailed\bright-college\meeting.jpg'}}" alt="project-detailed-2" style="transform: scaleX(-1);">



            </div>
            <div class="single-image">
                <img src="{{'assets\images\project-detailed\bright-college\uniform.jpg'}}" alt="project-detailed-3">
        ...
        <div class="single-image" style="background-color:#13263f;">
            <div style="background-image:url({{asset('assets/images/project-detailed/bright-college/handsome.jpg')}}); height:600px; width:100%; opacity:0.2;background-size:100% 600px; background-repeat:no-repeat">
